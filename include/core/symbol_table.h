...
static inline void type_table_init_builtins(struct type_table *table) {
    struct type_info *int32 = type_table_create_type_info("int32", TYPE_CATEGORY_BASIC, 4, NULL, NULL);
    ...
    type_table_insert(table, type_table_create_type_info("bool", TYPE_CATEGORY_BASIC, 1, NULL, NULL));
    ...
    // type_table_insert(table, type_table_create_type_info("ptr", TYPE_CATEGORY_POINTER, 8, NULL, NULL));
