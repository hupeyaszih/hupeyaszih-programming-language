...
enum IR_Instruction_type {
    ...
    IR_INSTRUCTION_TYPE_BITWISE_AND,
    IR_INSTRUCTION_TYPE_BITWISE_OR,
    IR_INSTRUCTION_TYPE_BITWISE_XOR,
    IR_INSTRUCTION_TYPE_SHL,
    IR_INSTRUCTION_TYPE_SHR,

    IR_INSTRUCTION_TYPE_UNARY_NOT,
